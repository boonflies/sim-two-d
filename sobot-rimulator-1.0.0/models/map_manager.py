...
from models.circular_obstacle import *
...
class MapManager:
  ...
  def random_map( self, *args ): # args = world - during initialize, args = world and obstacle_type during random map button click
    if len(args) == 2:
        # bind the world
        world = args[0]
        # Obstacle type
        obstacle_type = args[1]
    else:
        # bind the world
        world = args[0]

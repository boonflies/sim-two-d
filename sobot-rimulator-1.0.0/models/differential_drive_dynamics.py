...
##kinematics ---> constraints on pose variables and rates
##
##factors affecting dynamics: (takes in consideration, physical properties like
##all that which determines the next pose)
##    what about acceleration?
##    velocity ---> distance
##
##    linear and angular velocities (1 and 1 for car, 3 and 3 for uav)
